...
|-------|----|----|----|
|**EY한영**|**컨설팅부문 AI&Data팀 인턴**|2026.08~재직중|유통 대기업 순회영업 AI Agent 요건정의·기능정의서·화면설계 및 배점 로직 검증|
|전설텍 (프리랜서)|AI 개발·컨설팅|2026.04~2026.08|AI 디자인 생성 플랫폼, 이미지 처리 기반 진단 서비스 개발|
...
|------------|-----|----|
|2024 부천지역 대학연합 창업 공모전|우수상|2024.11|
|2023 관광데이터 활용 공모전|우수상|2023.11.29|
...
국내 특허 **출원 3건** (등록 전, 심사 진행 중)<br>
AI 디자인 생성 플랫폼 관련 2건 / 프라이버시 보호 카메라 필터 관련 1건
...
| [AI 영상 편집 서비스 Clipper-AI](https://github.com/LEGEND-Jeon/Clipper-AI) | 팀장, 기획, 인공지능 개발 총괄 | 2023.09~2024.09 | 가톨릭대 아이템경진대회 3위, 부천지역대학연합창업공모전 우수상 |
...
| Privacy-ON (AI 카메라 필터 하드웨어) | 기획, 개발 | (기간 확인 필요) | SK인텔릭스 NAMUHX 해커톤, 특허 출원 |
| APE-RL (시스템 프롬프트 자동 최적화) | 전체 | (기간 확인 필요) | A2C 기반 정책망으로 캐릭터 챗봇 프롬프트 최적화 |
| H&M × Google Trends 리테일 의사결정 자동화 툴 | PM, 데이터 파이프라인 | 2026.04~2026.06 | 데이터수집프로그래밍(교과목) 팀 프로젝트 |
| KPASS (외국인 근로자 신용평가 인프라) | 기획, 프로토타입 개발 | (기간 확인 필요) | FIN:NECT 챌린지 2026 |
| Heart Pixel (AI 연애 시뮬레이션 게임) | 기획, 개발 | (기간 확인 필요) | NHN NAN 2026 게임×AI 해커톤 출품 |

프리랜서 수행 프로젝트와 인턴 업무 결과물은 클라이언트 자산이라 코드를 공개하지 않습니다.
...
<img src="https://github-readme-stats.vercel.app/api?username=LEGEND-Jeon&show_icons=true&hide_border=true" height="150"/>
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=LEGEND-Jeon&layout=compact&hide_border=true" height="150"/>

<br><br><br>
📬 Contact 📬

<a href="https://www.linkedin.com/in/jeon-seol/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"/></a>
